	...
	public class SceneGeneratorInteract extends MovieClip 
	{
		...
		private function onEnterFrame(evt:Event):void
		{
			if(this.powerCore.y <= 140 && this.isHoldingCore)
			{
				...
				dialogBox.setData(["ALIEN|Hmm... This object seems to contain a large amount of power. I may be able to use this to power my ship!"]);
		...
		private function backButton_onTouchTap(evt:TouchEvent):void
		{
			...
			ProgressManager.hasTakenVillagePowerCore = this.hasTakenCore;
			
			this.stage.addChild(new Scene6Inside());
