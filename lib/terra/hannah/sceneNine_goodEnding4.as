package lib.terra.hannah {
	...
	//import lib.sceneNine_goodEnding5;
	
	import lib.terra.ui.DialogBox;
	import lib.terra.ui.DialogBoxEvent;
	
	public class sceneNine_goodEnding4 extends MovieClip {

		public function sceneNine_goodEnding4() {
		...
		{
			var _sceneFork:sceneNine_goodEnding5 = new sceneNine_goodEnding5();
